...
/**
 * Thrown to indicate that a command key String associated with a CommandMap had no mapping.
 */
public class NoSuchCommandException extends RuntimeException {
    ...
    static NoSuchCommandException forCommand(String command) {
        return new NoSuchCommandException("'" + command + "' does not exist");
    }
}
